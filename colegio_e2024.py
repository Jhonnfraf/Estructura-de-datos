...
class Colegio:
    ...
    def computar_nueva_nota(self, estud, nueva_nota):
        ...
        """
        estudiante=self.estudiantes.encontrar(estud)
        if self.estudiantes.encontrar(estudiante):
    ...
    def ubicar_estudiante(self, pos_loc):
        ...
        """
        if self.estudiantes.ubicar(pos_loc):
            return self.estudiantes.ubicar(pos_loc)
        else:
            return False
...
#-----------------------------------------------------------------------------
    ...
    #school.ver_estudiantes()
#-----------------------------------------------------------------------------
    print("PRUEBA DE COMPUTAR NOTAS 1 --------------------------------")
    ...
    print("PRUEBA DE COMPUTAR NOTAS 2--------------------------------")
    if school.computar_nueva_nota(Estudiante("1008"), nueva_nota=1.5):
        print("Actualización de notas EXITOSA!")
    else:
        print("NO pudo asignarse la nota!")
    print("\nVista de estudiantes matriculados:")
